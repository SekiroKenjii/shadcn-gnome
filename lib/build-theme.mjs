...
import { loadTheme, resolveThemeName, themeBuildDir } from './config.mjs';
...
.tab-background { border-radius: ${RADIUS}px ${RADIUS}px 0 0 !important; }
...
toolbarbutton:hover { background-color: ${d.hover} !important; border-radius: ${RADIUS}px !important; }
...
out('firefox/userChrome.css', firefoxChrome(d));
